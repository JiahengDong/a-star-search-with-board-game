...
def apply_ansi(s, bold=True, color=None):
    """
    ...
    s -- String to apply ANSI control codes to
    ...
    if color == "b":
        color_code = "\033[34m"
    return f"{bold_code}{color_code}{s}\033[0m"
...
def print_board(n, board_dict, message="", ansi=False, **kwargs):
    ...
    apply_ansi_s = apply_ansi if ansi else lambda s, **_: s
